...
data class AlarmItem(val documentId : String, val time : String, val userId : String,
                     val message : String, val type : AlarmType,
...
enum class AlarmType(val type : String) {
    ...
    TOGETHER("함께"), SUGGEST("건의"), MARKET("장터"); //, SIGNUP("가입승인")
    companion object{
