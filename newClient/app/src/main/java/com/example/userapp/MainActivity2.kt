...
import com.example.userapp.base.BaseActivity2
import com.example.userapp.databinding.ActivityMainBinding
import org.koin.androidx.viewmodel.ext.android.viewModel

class MainActivity2 : BaseActivity2<ActivityMainBinding, MainActivityViewModel>() {
    companion object{
    ...
    override fun initToolbar() {
        window.apply {
            navigationBarColor = ContextCompat.getColor(this@MainActivity2, R.color.white)
        }
    }
