...
import com.parasol.userapp.databinding.FragmentAlarmChildBinding
import com.parasol.userapp.utils.CustomedAlarmDialog
...
class AlarmReservationFragment(): BaseSessionFragment<FragmentAlarmChildBinding, AlarmViewModel>(){
    ...
    override fun initViewFinal(savedInstanceState: Bundle?) {
        viewmodel.getAlarmReservationList().observe(viewLifecycleOwner){
