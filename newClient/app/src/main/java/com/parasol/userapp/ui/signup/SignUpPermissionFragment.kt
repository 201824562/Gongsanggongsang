...
import com.parasol.userapp.databinding.FragmentSignupPermissionBinding
import com.parasol.userapp.restartActivity
import com.parasol.userapp.utils.MatchedFullDialogBasicOneButton
           ...
           signupNextbtn.setOnClickListener {
               if (nextBtnAvailable) {
                   if (checkServiceState()){
                       if (nextBtnAvailable) { findNavController().navigate(SignUpPermissionFragmentDirections.
                       actionSignUpPermissionFragmentToSignUpAgencyFragment(true)) }
