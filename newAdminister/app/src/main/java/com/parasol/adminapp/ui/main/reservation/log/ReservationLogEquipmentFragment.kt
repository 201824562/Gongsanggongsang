package com.parasol.adminapp.ui.main.reservation.log
...
import com.parasol.adminapp.databinding.FragmentReservationChildLogChildBinding
import com.parasol.adminapp.ui.main.reservation.ReservationViewModel
import com.parasol.adminapp.ui.main.reservation.log.ReservationLogFragment.Companion.TAB_INDEX_EQUIPMENT

class ReservationLogEquipmentFragment : BaseSessionFragment<FragmentReservationChildLogChildBinding, ReservationViewModel>(){
    ...
    override fun initViewFinal(savedInstanceState: Bundle?) {
        viewmodel.getReservationLogDataList(TAB_INDEX_EQUIPMENT).observe(viewLifecycleOwner){
