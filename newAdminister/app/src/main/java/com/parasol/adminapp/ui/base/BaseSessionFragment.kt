...
abstract class BaseSessionFragment<VB : ViewBinding, VM : BaseSessionViewModel> : Fragment() , BaseView  {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? { return initViewbinding(inflater, container, savedInstanceState) }
