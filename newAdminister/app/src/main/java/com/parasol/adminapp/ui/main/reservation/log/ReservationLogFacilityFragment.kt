...
import com.parasol.adminapp.ui.main.reservation.log.ReservationLogFragment.Companion.TAB_INDEX_FACILITY

class ReservationLogFacilityFragment : BaseSessionFragment<FragmentReservationChildLogChildBinding, ReservationViewModel>(){
    ...
    override fun initViewFinal(savedInstanceState: Bundle?) {
        viewmodel.getReservationLogDataList(TAB_INDEX_FACILITY).observe(viewLifecycleOwner){
