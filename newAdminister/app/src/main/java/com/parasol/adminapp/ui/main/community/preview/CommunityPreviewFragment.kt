package com.parasol.adminapp.ui.main.community.preview
...
import com.parasol.adminapp.databinding.FragmentCommunityPreviewBinding
...
class CommunityPreviewFragment : BaseSessionFragment<FragmentCommunityPreviewBinding, CommunityViewModel>() {
    ...
    override fun initViewStart(savedInstanceState: Bundle?) {
        getCollection = arguments?.getString("getCollectionName").toString()
